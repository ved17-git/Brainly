...
const contentController_4 = require("../controller/contentController");
...
exports.contentRouter.put('/updateContent', middleware_1.middleware, contentController_3.updateContent);
exports.contentRouter.delete('/deleteContent', middleware_1.middleware, contentController_4.deleteContent);
